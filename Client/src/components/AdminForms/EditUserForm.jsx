...
export default function UserForm() {
    ...
    const handleAddTournament = () => {
        ...
        setTournaments(prev => ({
            ...prev,
            [tournamentYear]: [...(prev[tournamentYear] || []), newTournament]
        }));
            ...
            <div className="user-form-wrapper">
                ...
                <form noValidate className="user-form-main" onSubmit={handleSubmit(editUser)}>
                    ...
                    <div className="user-form-section">
                        ...
                        <div className="user-form-tournament-stats-grid">
                            <div className="user-form-field">
                                <label className="user-form-label">Team Position</label>
                                <input
                                    type="number"
                            ...
                            <div className="user-form-field">
                                <label className="user-form-label">Points</label>
                                <input
                                    type="number"
                            ...
                            <div className="user-form-field">
                                <label className="user-form-label">Assists</label>
                                <input
                                    type="number"
                                    placeholder="Wins"
                                    className="user-form-input"
                            ...
                            <div className="user-form-field">
                                <label className="user-form-label">Rebounds</label>
                                <input
                                    type="number"
                                    placeholder="Losses"
                                    className="user-form-input"
                            ...
                            <div className="user-form-field">
                                <label className="user-form-label">Matches Played</label>
                                <input
                                    type="number"
                                    placeholder="Losses"
                                    className="user-form-input"
                                        ...
                                        .map(([year, tournamentList]) => (
                                            <div key={year} className="user-form-tournament-year-group">
                                                ...
                                                <ul className="user-form-tournament-items">
                                                    {tournamentList.map((tournament, index) => (
                                                        <li key={index} className="user-form-tournament-item">
                                                            <div className="user-form-tournament-info">
                                                                <strong>{tournament.name}</strong>
                                                                <div className="user-form-tournament-stats">
                                                                    <div className="">{tournament.stats?.teamPosition !== undefined && (
                                                                        <span>Team Position: {tournament.stats.teamPosition}</span>
                                                                    )}</div>
                                                                    <div className="">{tournament.stats?.points && (
                                                                        <span>Points: {tournament.stats.points}</span>
                                                                    )}</div>
                                                                    <div className="">{tournament.stats?.assists && (
                                                                        <span>Assists: {tournament.stats.assists}</span>
                                                                    )}</div>
                                                                    <div className="">{tournament.stats?.rebounds && (
                                                                        <span>Rebounds: {tournament.stats.rebounds}</span>
                                                                    )}</div>
                                                                    <div className="">
                                                                        {tournament.stats?.matchesPlayed && (
                                                                            <span>Matches Played: {tournament.stats.matchesPlayed}</span>
                                                                        )}</div>
                                                                </div>
                                                            </div>
                                                            <button
